					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner ml-auto">
									...
									<li style="color: red;font-size: 15px;border : 1px solid #a5a5a5;padding: 5px;"><b>USN :<?php echo " ".$_SESSION['usn']; ?></b></li>
									<li><a href=""></a></li>
								</ul>
			...
			<div class="row courses_row">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body">
							<center><h3 class="course_title"><a href="stdatd.php">Attendance </a></h3></center>
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body">
							<center><h3 class="course_title"><a href="stiam.php">IA Marks </a></h3></center>
							<div class="course_text">
